...
ims=[]
ims.append(np.array(Image.new('L', (20, 20)).paste(im.crop((0,0,19,height)),(0,0))))
ims.append(np.array(Image.new('L', (20, 20)).paste(im.crop((18, 0, 39, height)),(0,0))))
ims.append(np.array(Image.new('L', (20, 20)).paste(im.crop((39, 0, 59, height)),(0,0))))
ims.append(np.array(Image.new('L', (20, 20)).paste(im.crop((59, 0, 78, height)),(0,0))))
